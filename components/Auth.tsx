        ...
        <div className="mt-6 sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            <div className="mb-6">
                ...
                <div className="relative">
                    <select 
                        id="demo-user" 
                        className="block w-full rounded-lg border-0 py-2.5 pl-3 pr-10 bg-white/10 text-white ring-1 ring-inset ring-white/10 focus:ring-2 focus:ring-green-500 sm:text-sm sm:leading-6 cursor-pointer appearance-none hover:bg-white/20 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
