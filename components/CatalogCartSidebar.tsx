...
const CatalogCartSidebar: React.FC<CatalogCartSidebarProps> = ({ activeCart, onUpdateItem, onBackToDetail }) => {
  if (!activeCart) {
    return (
      <div className="bg-white p-6 rounded-2xl shadow-md border border-gray-200 h-full flex flex-col items-center justify-center">
  ...
  return (
    <div className="bg-white p-4 rounded-2xl shadow-md border border-gray-200 h-full flex flex-col" style={{minHeight: '60vh'}}>
      <h2 className="text-xl font-bold text-gray-800 mb-2 truncate" title={activeCart.name}>{activeCart.name}</h2>
